...
const metrics = [
  { title: "Total TRT's", value: "2,300", change: "+3% than last month", icon: Users, changeType: "up" },
  { title: "TRT Installations", value: "$53k", change: "+55% than last week", icon: DollarSign, changeType: "up" },
  { title: "TRT Transactions", value: "3,462", change: "-2% than yesterday", icon: MapPin, changeType: "down" },
  { title: "TRT Sales", value: "$103,430", change: "+5% than yesterday", icon: BarChart, changeType: "up" },
  { title: "Analytics", value: "8,900", change: "+2% than last month", icon: Users, changeType: "up" },
  { title: "Maintainance", value: "325", change: "-1% than last week", icon: Settings, changeType: "down" },
];

export default function TRTBlocks() {
  return (
