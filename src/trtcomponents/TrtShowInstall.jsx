...
const deposits = [
  { 
    id: "TRT-1001", period:getYesterdayDate(), date: "10 Mar, 2025", location: "Downtown Arcade", 
          ...
          <tbody>
            {deposits.map((deposit, index) => (
              ...
              >
                ...
                <td className="py-4 px-4">{selectedDate}</td>
