...
const metrics = [
  ...
  { title: "Total Employees", value: "2,300", change: "+3% than last month", icon:DollarSign, changeType: "up", component: <EmpShowAll/>  },
  { title: "Pay rol", value: "$53k", change: "+55% than last week", icon: Users , changeType: "up", component: <EmpShowPay/>  },
  { title: "Tasks", value: "3,462", change: "-2% than yesterday", icon: MapPin, changeType: "down", component: <EmpShowTask/>  },
  { title: "Performance", value: "$103,430", change: "+5% than yesterday", icon: BarChart, changeType: "up", component: <EmpShowPerf/>  },
...
export default function AccountBlocks() {
  const [selectedComponent, setSelectedComponent] = useState(<EmpShowAll/>); // Default component
