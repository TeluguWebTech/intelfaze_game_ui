...
const metrics = [
  { title: "Total Employees", value: "2,300", change: "+3% than last month", icon:DollarSign, changeType: "up" },
  { title: "Pay rol", value: "$53k", change: "+55% than last week", icon: Users , changeType: "up" },
  { title: "Tasks", value: "3,462", change: "-2% than yesterday", icon: MapPin, changeType: "down" },
  { title: "Performance", value: "$103,430", change: "+5% than yesterday", icon: BarChart, changeType: "up" },
...
export default function EmpBlocks() {
  return (
